                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                            ...
                                            <div class="content">
                                                <div class='col-lg-offset-2 col-lg-10 '>
                                                    <div class="input-group margin">
                                                        <textarea class="form-control custom-control" rows="8" style="resize:none" name="ads"></textarea>     
                                                        <span class="input-group-addon btn btn-primary">كود الاعلان</span>
                                                    </div>
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1" name="Page">
                                                            <?php
                                    $query = "select DISTINCT Page from  googel_ads ";
                                    $array = array();
                                    ...
                                    ?>
                                                    ...
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1" name="Location">
                                                             <?php
                                    $query = "select DISTINCT Location from  googel_ads ";
                                    $array = array();
                                    $rows = $class->sql_feth($Data_communication, $query, $array);
                                    if (count($rows) > 0) :
                                    ...
                                    ?>
                                                        ...
                                                        <span class="input-group-addon btn btn-primary"> مكان الاعلان</span>
                                                    </div>
                                                    <div class="input-group margin">
                                                        <select class="form-control input-lg" id="sel1" name="Activation">
                                                            <option>Activation</option>
                                                            <option>Inactivity</option>
                                                        </select>
                                                        <span class="input-group-addon btn btn-primary"> تفعيل الاعلان</span>
                                                    </div>
