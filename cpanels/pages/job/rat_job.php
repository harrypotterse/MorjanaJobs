                        ...
                        <div class="limiter">
                            <div class="container-table100">
                                <div class="wrap-table100">
                                    <div class="table100">
                                        <h1>أفضل  20 وظيفة في الموقع</h1>
                                        <table>
                                            <thead>
                                                <tr class="table100-head">
                                                    <th class="column3">المعدل</th>
                                                    <th class="column4">الشركة</th>
                                                    <th class="column5">الوظيفة</th>
                                                    <th class="column6">#</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php
                                                $query = "select * from  job ORDER BY `job`.`Views` DESC limit 20;";
                                                $array = array();
                                                ...
                                                if (count($rows) > 0) :
                                                    foreach ($rows as $value):
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="column4"><?php echo $Company; ?></td>
                                                            <td class="column5"><?php echo $Title; ?></td>
