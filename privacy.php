    ...
    <body id="bg">
        <div class="page-wraper">
            ...
            <div class="page-content bg-white">
                <!-- inner page banner -->
                <?php require_once './software_components/banner_privacy.php'; ?>
                <!-- Content -->
                <!-- Section Banner -->
                <?php require_once './software_components/section_privacy.php'; ?>
            </div>
            <!-- Content END-->
            <!-- Modal Box End -->
              <?php   echo googel_ads($Data_communication, "privacy", "Bottom"); ?>
            <!-- Footer -->
