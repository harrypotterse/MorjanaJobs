    ...
    <body id="bg">
        <div class="page-wraper">
            ...
            <div class="page-content bg-white">
                <!-- inner page banner -->
                <?php require_once './software_components/banner_usage.php'; ?>
                <!-- Content -->
                <!-- Section Banner -->
                <?php require_once './software_components/section_banner.php'; ?>
            </div>
            <!-- Content END-->
            <!-- Modal Box End -->
               <?php   echo googel_ads($Data_communication, "usage", "Bottom"); ?>
            <!-- Footer -->
